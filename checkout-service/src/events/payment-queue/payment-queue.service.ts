...
export class PaymentQueueService {
  ...
  constructor(private readonly reabbitMQService: RabbitmqService) {}
  ...
  async publishPaymentOrder(paymentOrder: PaymentOrderMessage): Promise<void> {
    ...
    try {
      ...
      await this.reabbitMQService.publishMessage(
        this.EXCHANGE, // Para onde vou enviar
        this.ROUTING_KEY, // Como rotear
        enrichmentMessage, // O que enviar [Conteudo]
      );
